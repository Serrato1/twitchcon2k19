...
function addProductBoxToDom({ url = '', description = '', img_url = '', price = '0.00', title = '', id = false }) {
    var formList = document.getElementById('form-list');
        var newInputBox = `
    <ul id="url-list" class="form-container">
     <li class="something">
        ...
        <div class="field-container">
            ...
            <input id='img_url-${id}' name='title' type="text" value="${img_url}" placeholder="add your image's url here" onchange='handleInputChange(this)'/>
        </div>
